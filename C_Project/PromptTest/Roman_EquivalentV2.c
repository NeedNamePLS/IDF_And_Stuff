...
int main()
{
    ...
    if (converter == 1)
    {
        while (decimalNum < 1 || decimalNum > 3999)
        {
            printf("Enter a decimal number ranging from 1 to 3999 | User Input: ");
            scanf("%d", &decimalNum);
            clear_input();
        }
        ...
        while (loop != 0)
        {
            ...
            for(i = 0; i < strlen(romanNum); i++)
            {
                ...
                if ((romanNum[i] == 'I' && romanNum[i+1] == 'I' && romanNum[i-1] == 'I' && romanNum[i+2] == 'I')||
                    ...
                    (romanNum[i] == 'I' && romanNum[i+1] == 'X' && romanNum[i+2] != '\0')||
                    (romanNum[i] == 'I' && romanNum[i+1] == 'V' && romanNum[i+2] != '\0')||
